              ...
              <div className="h-full flex divide-x divide-zinc-200/50 dark:divide-zinc-800/50">
                {daysList.map((day, idx) => {
                  ...
                  return (
                    <div
                      key={idx}
                      className={`h-full flex flex-col items-center justify-center font-bold text-[10px] font-mono shrink-0 ${
                        isToday ? "bg-purple-600/10 text-purple-600 dark:text-purple-400 border-x border-purple-500/20" : "text-zinc-500"
                      }`}
