...
export const InviteMembersModal: React.FC<InviteMembersModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-xs flex items-center justify-center p-3 sm:p-4 z-50 overflow-y-auto">
      <div className="bg-white dark:bg-zinc-900 border dark:border-zinc-800 w-full max-w-2xl rounded-2xl p-5 sm:p-6 shadow-2xl space-y-6 max-h-[90vh] flex flex-col transition-theme my-auto">
