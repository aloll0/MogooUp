      ...
      <div style={{ position: "absolute", top: "-9999px", left: "-9999px", opacity: 0, pointerEvents: "none" }}>
        ...
        >
          {reportMode === "client" ? (
            ...
            <div style={{ display: "flex", flexDirection: "column", flex: 1 }}>
              ...
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", borderBottom: "3px solid #7c3aed", paddingBottom: "20px", marginBottom: "30px" }}>
                ...
                <div style={{ textAlign: "right", fontSize: "11px", color: "#6b7280" }}>
                  ...
                  <p style={{ margin: "4px 0 0 0" }}>Arab Pro Project Management</p>
                </div>
              </div>
              ...
              <div style={{ marginTop: "auto", borderTop: "1px solid #e5e7eb", paddingTop: "14px", display: "flex", justifyContent: "space-between", fontSize: "10px", color: "#9ca3af" }}>
                <span>Report generated by Arab Pro Enterprise Digital Platform.</span>
            ...
            <div style={{ display: "flex", flexDirection: "column", flex: 1 }}>
              {/* PDF Report Header */}
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", borderBottom: "2px solid #b57ede", paddingBottom: "16px", marginBottom: "32px" }}>
                <div>
                  <h1 style={{ fontSize: "24px", fontWeight: "900", textTransform: "uppercase", color: "#843ec0", letterSpacing: "0.05em", margin: 0 }}>
                ...
                <div style={{ textAlign: "right", fontSize: "12px", fontWeight: "700", color: "#a1a1aa" }}>
                  ...
                  <p style={{ margin: "4px 0 0 0" }}>Arab Pro Productivity System</p>
                </div>
              </div>
