        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex bg-zinc-100 dark:bg-zinc-800 p-1 rounded-xl border dark:border-zinc-700 text-xs shrink-0 select-none font-bold">
            <button
              ...
              className={`px-3 py-1.5 rounded-lg transition-all cursor-pointer ${reportMode === "timesheet"
            ...
            <button
              ...
              className={`px-3 py-1.5 rounded-lg transition-all cursor-pointer ${reportMode === "client"
                  ? "bg-purple-650 text-white shadow-xs"
                  : "text-zinc-500 hover:text-zinc-700 dark:hover:text-zinc-200"
                }`}
            >
                        ...
                        {spaceTasks.map((t) => (
                          <div key={t._id} className="text-xs border-b dark:border-zinc-800/40 last:border-0 pb-2 last:pb-0 pt-1">
                            <div className="flex justify-between items-center font-bold">
                              <span>{t.title}</span>
                              <span className={`text-[9px] px-1.5 py-0.5 rounded capitalize ${t.status === "done" ? "bg-green-500/10 text-green-500" : "bg-amber-500/10 text-amber-500"
                                }`}>
                                {t.status}
                              </span>
                            </div>
